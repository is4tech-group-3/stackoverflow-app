...
import { AnswerUserModalComponent } from './answer-user-modal/answer-user-modal.component';
...
export class AnswersUserComponent implements OnInit, AfterViewChecked {
  ...
  openEditModal(): void {
    const dialogRef = this.dialog.open(AnswerUserModalComponent, {
      data: { question: this.question } // Pasar la pregunta al modal
    });
  ...
  closeModal(): void {
    // No es necesario ya que el modal se cierra automáticamente
  }
}
